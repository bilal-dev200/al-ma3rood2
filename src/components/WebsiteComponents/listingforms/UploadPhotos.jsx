...
<div className="w-full max-w-5xl px-4 sm:px-6">
  <h2 className="text-2xl sm:text-3xl font-bold mb-2">{t("Photos")}</h2>
  ...
  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 sm:gap-6">
    ...
    {images.length < 20 && (
      <div
        className={`aspect-square w-full rounded-md p-6 flex flex-col items-center justify-center text-center text-sm bg-white cursor-pointer transition ${
          errors.images
      ...
      >
        ...
        >
          <FiUploadCloud
            size={30}
            className={`mb-2 ${
              errors.images ? "text-red-500" : "text-green-600"
            }`}
          />
